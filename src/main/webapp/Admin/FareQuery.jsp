...
function changePage(p){
	...
	location.href="<%=request.getContextPath()%>/TicketSerlvet?page="+p+"&size="+sizes;
}
function deleteById(){
	var form=document.TicketForm;
	form.action="<%=request.getContextPath()%>/TicketDeleteByIdServlet";
	//多选框效验
      ...
      <tr>
        ...
        <table width="553" border="1" align="center" cellpadding="0" cellspacing="1" bordercolor="#dadada" bgcolor="#FFFFFF">
          <tr align="center">
            ...
            <td width="80" height="25" valign="middle" bordercolor="#FFFFFF" bgcolor="#FFFFFF"  class="text_cray1">车站id</td>
            <td width="80" height="25" valign="middle" bordercolor="#FFFFFF" bgcolor="#FFFFFF"  class="text_cray1">车站名称</td>
            <td width="80" height="25" valign="middle" bordercolor="#FFFFFF" bgcolor="#FFFFFF"  class="text_cray1">所在省份</td>
             <td width="80" height="25" valign="middle" bordercolor="#FFFFFF" bgcolor="#FFFFFF"  class="text_cray1">照片描述</td>
